...
public class SimulatorU546ClusterApproval {
    ...
    public static void initializer(String instance) {
        if (instance.equals("DEV_URL")) {
            ...
            CLIENT_ID = "simulator-u546";
            USERNAME = "tvsmdev";
            PASSWORD = "TvsmDevMqttBroker";
            TOPIC = "u546-telem-test";
    ...
    public static void U546ClusterApproval(String instance, String sheetName, int rowIndex, int colIndex, int seqNo) {
...
//             cellData = "#RES,SRV,VIN_GENERIC,555552000002212,1062244,1,OK*15";
            ...
            for (String packet : packets) {
                ...
                // Replace 5th element (index 4) with seqNo
                if (parts.length >= 5) {
                    parts[4] = String.valueOf(seqNo);
                }
