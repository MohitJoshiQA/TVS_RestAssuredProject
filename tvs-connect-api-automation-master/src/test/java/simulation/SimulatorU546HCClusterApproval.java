...
public class SimulatorU546HCClusterApproval {
    ...
    public static void U546HCClusterApproval(String instance, String sheetName, int rowIndex, int colIndex, int seqNo) {
