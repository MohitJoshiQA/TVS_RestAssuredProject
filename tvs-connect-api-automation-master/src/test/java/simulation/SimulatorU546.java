...
public class SimulatorU546 {
    ...
    public static void U546(String instance, String sheetName, int rowIndex, int colIndex) {
        ...
        try {
            ...
            for (String packet : packets) {
                ...
                fields[4] = starttime; // Assuming timestamp is at index 4
